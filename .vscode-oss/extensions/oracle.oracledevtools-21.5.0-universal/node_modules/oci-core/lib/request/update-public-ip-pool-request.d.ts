...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.28.0/core/UpdatePublicIpPool.ts.html |here} to see how to use UpdatePublicIpPoolRequest.
 */
